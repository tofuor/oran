...
echo "Control Panel"
docker run -d --rm -v /home/oran/Desktop/nonrtric_config/control_panel/nginx.conf:/etc/nginx/nginx.conf -p 8080:8080 --network=nonrtric-docker-net --name=control-panel  nexus3.o-ran-sc.org:10002/o-ran-sc/nonrtric-controlpanel:2.3.0


echo ""

echo "Gateway"
docker run -d --rm -v /home/oran/Desktop/nonrtric_config/nonrtric_gateway/application.yaml:/opt/app/nonrtric-gateway/config/application.yaml -p 9090:9090 --network=nonrtric-docker-net --name=nonrtric-gateway  nexus3.o-ran-sc.org:10002/o-ran-sc/nonrtric-gateway:1.0.0

echo ""

echo "Dmaap Adapter Service"
docker run -d --rm \
-v /home/oran/Desktop/nonrtric_config/dmaap_adapter/application.yaml:/opt/app/dmaap-adapter-service/config/application.yaml \
-v /home/oran/Desktop/nonrtric_config/dmaap_adapter/application_configuration.json:/opt/app/dmaap-adapter-service/data/application_configuration.json \
...
docker run -d --rm -v \
/home/oran/Desktop/nonrtric_config/dmaap_mediator_producer/type_config.json:/configs/type_config.json \
